...
const checkObj = {
    ...
    memberNickname: false, // 1) 정규표현식(영어/숫자/한글 2~10글자 사이)형식 맞는지 체크 -> 2) ajax통신(중복검사)
...
const cMessasge = document.getElementById("cMessage");
...
sendBtn.addEventListener("click", function () {
    if (checkObj.memberEmail) {
        ...
        checkInterval = setInterval(function() {
			...
			if(min === -1) { // 만료
				cMessasge.classList.add("error");
				cMessasge.innerText = "인증번호가 만료되었습니다.";
